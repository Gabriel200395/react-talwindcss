...
const ArticleItem = ({ text, img }: { text: string, img: string }) => {
    return (
        <div className="bg-slate-200  rounded px-10 py-10 flex flex-col items-center justify-center">
            <p className="font-normal text-base text-black text-left mb-5">{text}</p>
